        ...
        if ( sizeof( $woocommerce->cart->get_cart() ) > 0 ) {
          ...
          <?php
            ...
            ?>
                ...
                <a href="<?php echo $woocommerce->cart->get_cart_url(); ?>" class="button left"><span><?php echo __('View Cart', ETHEME_DOMAIN); ?></span></a>  
                <a href="<?php echo $woocommerce->cart->get_checkout_url(); ?>" class="button filled active right "><span><?php echo __('Checkout', ETHEME_DOMAIN); ?></span></a>   
