...
if(!function_exists('etheme_VS_setup')) {
	...
	function etheme_VS_setup() {
		...
		$row_params = array('params' => array(
	        ...
	        array(
	          "type" => "dropdown",
	          "heading" => __("Full width section", ETHEME_DOMAIN),
	        ...
	        array(
	          ...
	          "value" => array( "", __("light with black text", ETHEME_DOMAIN) => 'light',  __("dark with white text", ETHEME_DOMAIN) => 'dark'),
	            "dependency" => Array('element' => "full_width", 'value' => array('1'))
	        ),
	        array(
	          "type" => "textfield",
			...
			array(
				"type" => "css_editor",
				"heading" => __('CSS for section', "js_composer"),
				"param_name" => "css_outer",
	    ...
	    function vc_theme_vc_column_inner($atts, $content = null) {
	        ...
	        $output .= "\n\t".'<div class="wpb_column_inner '.$el_class.'">';
	        $output .= "\n\t\t".'<div class="wpb_wrapper">';
	        $output .= "\n\t\t\t".wpb_js_remove_wpautop($content);
	        $output .= "\n\t\t".'</div>';
	        $output .= "\n\t".'</div>';
