...
class WC_Widget_Price_Filter_Custom extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_name        = __( 'WooCommerce Price Filter Custom', 'woocommerce' );
		$this->settings           = array(
			'title'  => array(
				'type'  => 'text',
		...
		echo '<div class="widget_price_filter"><form method="get" action="' . esc_attr( $form_action ) . '">
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
					...
					<button type="submit" class="button">'.__( 'F', 'woocommerce' ).'</button>
